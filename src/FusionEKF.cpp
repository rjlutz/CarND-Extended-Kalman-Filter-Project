...
FusionEKF::FusionEKF() {
    ...
    noise_ax = 9;     // acceleration noise components,
    noise_ay = 9;     // provided with project spec
...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
    ...
    ekf_.F_(0, 2) = dt; //Modify the F matrix so that the time from this update is integrated
    ekf_.F_(1, 3) = dt;

    //set the process covariance matrix Q
    float dt_2 = dt * dt;    // calculate once
    float dt_3 = dt_2 * dt;
    float dt_4 = dt_3 * dt;
